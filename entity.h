...
public:
	...
	float                   m_speed_2d,
		...
		m_speed_as_portion_of_walk_speed, // csgo::m_unk_feet_speed_ratio
...
public:
	...
	__forceinline C_AnimationLayer* layers() {
		return *reinterpret_cast<C_AnimationLayer**>(reinterpret_cast<uintptr_t>(this) + 0x2970);
	}
	...
	void attachments_helper(CStudioHdr* hdr) {
		...
		((AttachmentHelperFn)g_csgo.m_AttachmentHelper)(this, hdr);
	}
...
public:
	...
	float max_speed() {
		...
		return util::get_method< float(__thiscall*)(void*) >(this, 442)(this);
	}
