...
namespace ns_surface {
	...
	void draw_filled_rect(int x, int y, int w, int h, int r, int g, int b) {
		render::rect_filled( x, y, w, h, Color( r, g, b ) );
	}

	void draw_outlined_rect( int x, int y, int w, int h, int r, int g, int b, int a ) {
		render::rect( x, y, w, h, Color( r, g, b, a ) );
	}
...
void c_lua::init() {
	...
	this->lua.new_usertype<CCSGOPlayerAnimState>("c_animstate",
		...
		"last_cs_anim_update_time", &CCSGOPlayerAnimState::m_last_update_time,
		"last_cs_anim_update_fc", &CCSGOPlayerAnimState::m_last_update_frame,
		"update_time_delta", &CCSGOPlayerAnimState::m_last_update_increment,
		"yaw", &CCSGOPlayerAnimState::m_eye_yaw,
		"pitch", &CCSGOPlayerAnimState::m_eye_pitch,
		"goal_feet_yaw", &CCSGOPlayerAnimState::m_foot_yaw,//?
		"current_feet_yaw", &CCSGOPlayerAnimState::m_last_foot_yaw,//?
		"fall_velocity", &CCSGOPlayerAnimState::m_up_speed,//?
		"m_speed", &CCSGOPlayerAnimState::m_speed_2d,
